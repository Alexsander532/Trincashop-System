      ...
      <div class="login-card glass animate-fade-in-up">
        ...
        <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="login-form">
          ...
          <div class="form-group">
            ...
            <input type="password" id="password" formControlName="password" class="form-control" placeholder="••••••••" autocomplete="current-password">
...
export class LoginComponent {
    ...
    constructor(private fb: FormBuilder, private authService: AuthService, private router: Router) {
        this.loginForm = this.fb.group({
            email: ['admin@trincashop.com', [Validators.required, Validators.email]],
